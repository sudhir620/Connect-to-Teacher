        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    csDepartment.setLayoutManager(new LinearLayoutManager(TeacherDetails.this));
                    adapter = new TeacherAdapter(list1, TeacherDetails.this, "Computer Science Department");
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(TeacherDetails.this, ""+databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    machenicalDepartment.setLayoutManager(new LinearLayoutManager(TeacherDetails.this));
                    adapter = new TeacherAdapter(list2, TeacherDetails.this, "Machenical Department");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    civilDepartment.setLayoutManager(new LinearLayoutManager(TeacherDetails.this));
                    adapter = new TeacherAdapter(list3, TeacherDetails.this, "Civil Department");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    automobileDepartment.setLayoutManager(new LinearLayoutManager(TeacherDetails.this));
                    adapter = new TeacherAdapter(list4, TeacherDetails.this, "Automobile Department");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    electricalDepartment.setLayoutManager(new LinearLayoutManager(TeacherDetails.this));
                    adapter = new TeacherAdapter(list5, TeacherDetails.this, "Electrical Department");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    eceDepartment.setLayoutManager(new LinearLayoutManager(TeacherDetails.this));
                    adapter = new TeacherAdapter(list6, TeacherDetails.this,"ECE Department");
